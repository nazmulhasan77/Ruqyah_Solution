...
class DiagnosisQuestion {
  ...
  factory DiagnosisQuestion.fromJson(Map<String, dynamic> j) =>
      DiagnosisQuestion(
...
class DiagnosisCategory {
  ...
  factory DiagnosisCategory.fromJson(Map<String, dynamic> j) =>
      DiagnosisCategory(
  ...
  String get shortTitle {
    final t = diagnosisType.replaceAll('যাচাই সম্পন্ন হয়েছে', '').trim();
    return t;
  }
}
...
class _RuqyahDiagnosisPageState extends State<RuqyahDiagnosisPage> {
    ...
    if (mounted) {
      setState(() {
        ...
        if (_categories.isEmpty) {
          _error = 'ডেটা লোড করা যায়নি। ইন্টারনেট পরীক্ষা করুন।';
        }
      });
    }
  }
  ...
  static const List<Map<String, dynamic>> _meta = [
    {
      'icon': '👶',
      'colors': [Color(0xFF6C3CE1), Color(0xFF9B6FF5)],
    },
    {
      'icon': '🧒',
      'colors': [Color(0xFF0891B2), Color(0xFF4A90D9)],
    },
    {
      'icon': '🪄',
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'প্রশ্নের উত্তর দিন এবং জানুন আপনার সমস্যার ধরন ও সমাধান',
                style: GoogleFonts.hindSiliguri(
                  fontSize: 12,
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(
                    'প্রশ্ন ${_currentQ + 1} / ${_questions.length}',
                    style: GoogleFonts.hindSiliguri(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      color: AppColors.primary,
                  ...
                  Text(
                    '${(_answers.length)} টি উত্তর দেওয়া হয়েছে',
                    style: GoogleFonts.hindSiliguri(
                      fontSize: 11,
                      color: Colors.grey,
                    ),
            ...
            child: Column(
              ...
              children: [
                ...
                ...q.options.map((opt) {
                  ...
                  Color optColor;
                  if (opt == 'হ্যাঁ') {
                    optColor = const Color(0xFFDC2626);
                  } else if (opt == 'মাঝে মধ্যে') {
                    optColor = const Color(0xFFD97706);
                  } else {
                    optColor = const Color(0xFF059669);
                  }
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: isSelected
                            ? [
                                BoxShadow(
                                  color: optColor.withValues(alpha: 0.2),
                                  blurRadius: 8,
