...
class DuaChapter {
  ...
  int get totalDuas => groups.fold(0, (sum, g) => sum + g.duas.length);
}
...
class _RuqyahDuaPageState extends State<RuqyahDuaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: _buildAppBar(),
      body: SingleChildScrollView(child: _buildBody(isDark)),
    );
  }
  ...
  Widget _buildChapterCard(DuaChapter chapter, List<Color> gradientColors) {
